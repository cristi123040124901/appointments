// src/lib/email/booking-reminder.ts
...
export function bookingReminderHtml(input: BookingReminderEmailInput): string {
  const {
    tenantName,
    brandColor,
    customerName,
  ...
  <div style="font-family: -apple-system, Segoe UI, Roboto, sans-serif; max-width: 480px; margin: 0 auto; color: #1e293b;">
    ...
    <div style="border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 12px 12px; padding: 24px;">
      ...
      <p style="font-size: 15px; line-height: 1.5;">Îți amintim de programarea de mâine:</p>
